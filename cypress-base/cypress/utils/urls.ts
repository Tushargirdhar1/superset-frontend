...
export const WORLD_HEALTH_DASHBOARD = '/vyakriti/dashboard/world_health/';
export const SAMPLE_DASHBOARD_1 = '/vyakriti/dashboard/1-sample-dashboard/';
export const SUPPORTED_CHARTS_DASHBOARD =
  '/vyakriti/dashboard/supported_charts_dash/';
export const TABBED_DASHBOARD = '/vyakriti/dashboard/tabbed_dash/';
